        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConvertedManaCost = table.Column<string>(type: "text", nullable: false),
                    ...
                    MultiverseId = table.Column<int>(type: "integer", nullable: true),
                    ...
                    MtgId = table.Column<string>(type: "text", nullable: false),
                    Variations = table.Column<string>(type: "text", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    RarityCodeNavigationId = table.Column<long>(type: "bigint", nullable: true),
                    SetCodeNavigationId = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Cards_Rarity_RarityCodeNavigationId",
                        column: x => x.RarityCodeNavigationId,
                        principalTable: "Rarity",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Cards_Set_SetCodeNavigationId",
                        column: x => x.SetCodeNavigationId,
                        principalTable: "Set",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CardColor_Cards_CardId",
                        column: x => x.CardId,
                        principalTable: "Cards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CardColor_Color_ColorId",
                        column: x => x.ColorId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CardColor_CardId",
                table: "CardColor",
                column: "CardId");

            migrationBuilder.CreateIndex(
                name: "IX_CardColor_ColorId",
                table: "CardColor",
                column: "ColorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cards_RarityCodeNavigationId",
                table: "Cards",
                column: "RarityCodeNavigationId");

            migrationBuilder.CreateIndex(
                name: "IX_Cards_SetCodeNavigationId",
                table: "Cards",
                column: "SetCodeNavigationId");
